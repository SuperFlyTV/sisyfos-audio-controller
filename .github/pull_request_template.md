...
<!--
Please provide some details on what areas of the system are affected by this PR.
This is useful for testers to know where to focus their testing efforts.
Examples:
* This PR affects the connection handling logic in general.
* This PR affects the timing calculation during state resolution.
-->
